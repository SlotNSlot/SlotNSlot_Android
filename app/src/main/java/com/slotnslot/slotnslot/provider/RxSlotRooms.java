...
//        SlotRoom test = new SlotRoom("test", "test", 0.15, 2000, 120.001, 1.050, "test", Convert.toWei(10, Convert.Unit.ETHER));
//        test.setPlayerBalance(Convert.toWei(1, Convert.Unit.ETHER));
//        addSlot(test);
